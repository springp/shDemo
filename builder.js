...
//Download
 $("#newsletter-builder-sidebar-buttons-abutton").click(function(){
	...
	//$("#export-textarea").val(' ');
	 ...
	 $("#newsletter-preloaded-export").html(export_content);
});
...
$("#newsletter-builder-sidebar-buttons-bbutton").click(function(){
	...
	$.ajax({
	  url: "http://simbyone.com/demo/drag-and-drop-newsletter-builder-using-jquery/_css/newsletter.css"
	}).done(function(data) {
	...
	//$("#newsletter-preloaded-export").html($("#newsletter-builder-area-center-frame-content").html());
	$("#sim-edit-export .text").val('<div id="sim-wrapper"><div id="sim-wrapper-newsletter">'+$("#newsletter-preloaded-export").html()+'</div></div>');
	});
	
$(".btn_preview_export").click(function(){
	$("#sim-preview-export").fadeIn(500);
	$("#sim-preview-export .sim-preview-box").slideDown(500);
	$("#newsletter-preloaded-export").html($("#newsletter-builder-area-center-frame-content").html());
	$("#newsletter-preloaded-export .sim-row-delete").remove();
	$("#newsletter-preloaded-export .sim-row").removeClass("ui-draggable");
	$("#newsletter-preloaded-export .sim-row-edit").removeAttr("data-type");
	$("#newsletter-preloaded-export .sim-row-edit").removeClass("sim-row-edit");
	$(".sim-preview-box").html('<div id="sim-wrapper"><div id="sim-wrapper-newsletter">'+$("#newsletter-preloaded-export").html()+'</div></div>');
});
});
